...
export function SetupScreen() {
	return (
		<Layout>
			<HStack w={"60%"} h={"60%"} bgColor={"gray.900"} rounded={"xl"} shadow={"sm"} p={"5rem"}
	...
	return (
		<Flex w={"33%"} align={"center"} justify={"center"} direction={"column"} gap={"3rem"}>
			...
			<Text textStyle={"sm"} textAlign={"justify"}>Ici nous allons créer le compte administrateur pour votre
				installation. Il vous servira à créer/gérer les rôles et utilisateurs de votre installation.<br/>
				Ce compte ne dois en aucun cas être perdu, en cas de perte, veuillez contacter le support. Une intervention sera necessaire.</Text>
		</Flex>
	);
}